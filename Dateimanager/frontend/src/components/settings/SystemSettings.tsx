  ...
  return (
    <div className="settings-section">
      <div className="events-section">
        ...
        <div>
          <label htmlFor="checkInterval" className="search-relevance-input">
            ...
            <input
              ...
              value={checkInterval}
              onChange={(e) =>
                setCheckInterval(parseInt(e.target.value, 10) || 60)
              }
              min="1"
            />
          </label>
          <p className="setting-description">
            Wie oft überprüft wird ob eines der Events fällig ist (in Sekunden).
          </p>
        </div>
      </div>
              ...
              <div className="form-group">
                ...
                >
                  ...
                  {ALLOWED_EVENTS.filter((o) =>
                    editingIndex === "new"
                      ? !events.some((ev) => ev.event === o.value)
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      frequency: e.target.value as FrequencyOption["value"],
                    })
                  }
                >
                  {FREQUENCIES.map((f) => (
          ...
          <div className="modal-content modal-danger">
            ...
            {shutdownError && (
              <p
                ...
                style={{ color: "var(--text-danger)", marginBottom: "0.5rem" }}
              >
                {shutdownError}
              </p>
            )}
            ...
            >
              <button onClick={confirmShutdown} className="confirm-btn">
                Bestätigen
              </button>
              <button
                onClick={() => {
